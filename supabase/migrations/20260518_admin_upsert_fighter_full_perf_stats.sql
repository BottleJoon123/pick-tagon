-- ================================================================
-- admin_upsert_fighter: sapm, str_def, td_acc, td_def 컬럼 추가
--
-- 배경: Step A (자동 계산 버튼) 구현 시 4개 raw stat 폼 입력 추가됐으나
--       기존 RPC가 INSERT/UPDATE에서 이를 무시 → silent data loss.
--       fighters 테이블에 컬럼은 이미 존재함 (20260418_add_fighter_stat_columns.sql).
-- ================================================================
